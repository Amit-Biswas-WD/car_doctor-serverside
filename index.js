...
app.use(
  cors({
    origin: [
      "http://localhost:5173",
      "https://cars-doctor-b479f.web.app",
      "https://cars-doctor-b479f.firebaseapp.com",
    ],
    credentials: true,
  })
);
...
const verifyToken = async (req, res, next) => {
  ...
  jwt.verify(token, process.env.ACCESS_TOKEN_SECRET, (err, decoded) => {
    ...
    // if token is valid then it would
...
app.listen(port, () => {
  console.log(`Car Doctor Server is Running on Part ${port}`);
});
